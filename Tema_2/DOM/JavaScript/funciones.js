...
const buscarPorSelectorTodos = () => {
    ...
    document.getElementById("resultado-busqueda").textContent = `Elementos encontrados por querySelectorAll: ${elementos.length}`;
}
...
const alternarClase = () => {
    ...
    document.getElementById("resultado-busqueda").textContent = "Cambiado el color o quitado";
}
...
const mostrarNodeName = () => {
    ...
    document.getElementById("resultado-reemplazo").textContent = `El nodeName del elemento seleccionado es: ${nodeName}`;
}
...
const reemplazarTextContent = () => {
    const parrafo = document.getElementById("parrafo-reemplazo");
    parrafo.textContent = "Este es el nuevo contenido usando textContent. Solo el texto cambia, no el HTML.";
    document.getElementById("resultado-reemplazo").textContent = "Contenido reemplazado usando textContent.";
}

/*Interpretando el código HTML indicado y mostrando sus elementos:*/
const reemplazarInnerHTML = () => {
    const parrafo = document.getElementById("parrafo-reemplazo");
    parrafo.innerHTML = "<strong>Este es el nuevo contenido usando innerHTML.</strong> Puede incluir <em>HTML</em>.";
    document.getElementById("resultado-reemplazo").textContent = "Contenido reemplazado usando innerHTML.";
}

const reemplazarOuterHTML = () => {
    const parrafo = document.getElementById("parrafo-reemplazo");
    parrafo.outerHTML = "<div id='parrafo-reemplazo'><em>Este es el nuevo contenido reemplazado con outerHTML.</em> El elemento <strong>p</strong> fue reemplazado por un <strong>div</strong>.</div>";
    document.getElementById("resultado-reemplazo").textContent = "Contenido reemplazado usando outerHTML. El elemento original fue reemplazado.";
}
...
const insertarAppendChild = () => {
    ...
    document.getElementById("resultado-insercion").textContent = "Elemento insertado con appendChild.";
}

const insertarAdjacentElement = () => {
    const contenedor = document.getElementById("contenedor-insercion");
    const nuevoElemento = document.createElement("p");
    nuevoElemento.textContent = "Elemento añadido con insertAdjacentElement en 'beforeend'.";
    nuevoElemento.classList.add("activa");  // Añadir clase activa
    contenedor.insertAdjacentElement("beforeend", nuevoElemento);
    document.getElementById("resultado-insercion").textContent = "Elemento insertado con insertAdjacentElement en posición 'beforeend'.";
}

const insertarAdjacentHTML = () => {
    const contenedor = document.getElementById("contenedor-insercion");
    contenedor.insertAdjacentHTML("afterbegin", "<p class='activa'>Elemento añadido con insertAdjacentHTML en 'afterbegin'.</p>");
    document.getElementById("resultado-insercion").textContent = "Elemento insertado con insertAdjacentHTML en posición 'afterbegin'.";
}
//! Insertar en 'beforebegin' - dentro del contenedor antes de su primer hijo
const insertarAdjacentText = () => {
    const contenedor = document.getElementById("contenedor-insercion");
    const texto = document.createTextNode("Texto añadido con insertAdjacentText antes del contenedor. ");
    ...
    document.getElementById("resultado-insercion").textContent = "Texto insertado con insertAdjacentText en posición 'beforebegin'.";
}
...
const insertarAfterBegin = () => {
    const contenedor = document.getElementById("contenedor-insercion");
    const nuevoElemento = document.createElement("p");
    nuevoElemento.textContent = "Elemento añadido con insertAdjacentElement en 'afterbegin'.";
    nuevoElemento.classList.add("activa");  // Añadir clase activa
    contenedor.insertAdjacentElement("afterbegin", nuevoElemento);
    document.getElementById("resultado-insercion").textContent = "Elemento insertado en posición 'afterbegin'.";
};
...
const insertarBeforeEnd = () => {
    ...
    nuevoElemento.classList.add("activa");  // Añadir clase activa
    contenedor.insertAdjacentElement("beforeend", nuevoElemento);
    document.getElementById("resultado-insercion").textContent = "Elemento insertado en posición 'beforeend'.";
};
...
const insertarAfterEnd = () => {
    const contenedor = document.getElementById("contenedor-insercion");
    const nuevoElemento = document.createElement("p");
    nuevoElemento.textContent = "Elemento añadido con insertAdjacentElement en 'afterend'.";
    nuevoElemento.classList.add("activa");  // Añadir clase activa
    contenedor.insertAdjacentElement("afterend", nuevoElemento);
    document.getElementById("resultado-insercion").textContent = "Elemento insertado en posición 'afterend'.";
};
...
const insertarBefore = () => {
    ...
    document.getElementById("resultado-insercion").textContent = "Elemento insertado con insertBefore antes del primer párrafo.";
}
...
const borrarInserciones = () => {
    ...
    document.getElementById("resultado-insercion").textContent = "Elementos Borrados";
};
...
const eliminarConRemove = () => {
    ...
    if (parrafo) {
        parrafo.remove();
        document.getElementById("resultado-eliminar").textContent = "Elemento eliminado con .remove()";
    } else {
        document.getElementById("resultado-eliminar").textContent = "El elemento ya ha sido eliminado.";
    }
};
...
const eliminarConRemoveChild = () => {
    ...
    if (parrafo) {
        ...
        document.getElementById("resultado-eliminar").textContent = "Elemento eliminado con .removeChild()";
    } else {
        document.getElementById("resultado-eliminar").textContent = "El elemento ya ha sido eliminado.";
    }
};
...
const reemplazarConReplaceChild = () => {
    ...
    if (parrafo) {
        const nuevoElemento = document.createElement("p");
        nuevoElemento.textContent = "Este es el nuevo párrafo reemplazado con .replaceChild().";
        contenedor.replaceChild(nuevoElemento, parrafo);
        document.getElementById("resultado-eliminar").textContent = "Elemento reemplazado con .replaceChild()";
    } else {
        document.getElementById("resultado-eliminar").textContent = "El elemento ya ha sido reemplazado.";
    }
};
...
const crearLosParrafos = () => {
    ...
    parrafoRemoveChild.textContent = "Este párrafo será eliminado con .removeChild().";
    ...
    parrafoReplaceChild.textContent = "Este párrafo será reemplazado con .replaceChild().";
    contenedor.appendChild(parrafoReplaceChild);

    document.getElementById("resultado-eliminar").textContent = "Párrafos iniciales restaurados.";
};
...
const mostrarClassName = () => {
    ...
    document.getElementById("resultado-clase").textContent = `Valor de .className: ${elemento.className}`;
};
...
const mostrarClassList = () => {
    ...
    document.getElementById("resultado-clase").textContent = `Lista de clases (.classList): ${clases}`;
};
...
const agregarClases = () => {
    ...
    document.getElementById("resultado-clase").textContent = "Clases 'resaltado' y 'negrita' añadidas.";
};
...
const quitarClases = () => {
    ...
    document.getElementById("resultado-clase").textContent = "Clases 'resaltado' y 'negrita' eliminadas.";
};
...
const verificarClase = () => {
    ...
    document.getElementById("resultado-clase").textContent = `¿El elemento tiene la clase 'resaltado'? ${tieneClase}`;
};
...
const cambiarClase = () => {
    ...
    document.getElementById("resultado-clase").textContent = "Clase 'resaltado' alternada.";
};
...
const alternarClaseCondicional = () => {
    ...
    document.getElementById("resultado-clase").textContent = `Clase 'negrita' ${agregarClase ? "añadida" : "eliminada"} condicionalmente.`;
};
...
const reemplazarClase = () => {
    ...
    if (elemento.classList.contains("resaltado")) {
        ...
        document.getElementById("resultado-clase").textContent = "Clase 'resaltado' reemplazada por 'negrita'.";
    } else {
        document.getElementById("resultado-clase").textContent = "La clase 'resaltado' no está presente para reemplazar.";
    }
};
